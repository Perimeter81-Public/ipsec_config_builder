...
@click.option("--vendor", prompt=True,
              type=click.Choice(['cisco', 'palo', 'fortinet', 'mikrotik'], case_sensitive=False, ))
...
@click.option("--p81_gw", prompt="VPN Name", help="Name of the VPN Perimter81.")
...
@click.option("--psk", prompt="Preshare Key", help="Preshare Key.")
@click.option("--encry", prompt=True,
              type=click.Choice(["3des", "blowfish128", "blowfish192", "blowfish256", "aes128", "aes192", "aes256"],
